...
export function OnboardingTracker() {
    ...
    const { candidates, loading, error, lastUpdate, recentUpdates, statusCounts, updateCandidate, refresh, isRealTime } = useRealTimeOnboarding({
...
//# sourceMappingURL=OnboardingTracker.js.map