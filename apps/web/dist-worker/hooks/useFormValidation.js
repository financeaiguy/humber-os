...
export function useFormValidation() {
    ...
    const validateField = useCallback((field, value, fullData) => {
        try {
            const fieldSchema = OnboardingValidationSchema.shape[field];
            if (!fieldSchema) {
            ...
            if (field.includes('.')) {
                ...
                const parentSchema = OnboardingValidationSchema.shape[parentField];
...
export function formatLegalIdentifier(type, value) {
