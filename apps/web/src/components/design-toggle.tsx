  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 left-4 z-50 w-12 h-12 bg-slate-800 border-2 border-slate-600 rounded-full shadow-lg flex items-center justify-center hover:shadow-xl transition-all duration-200"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 left-4 z-50 bg-slate-900 border border-slate-700 rounded-lg shadow-xl p-4 w-72"
          >
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-slate-100 mb-1">Design Mode</h3>
              ...
              <div className="space-y-3">
                ...
                <div 
                  className={`p-3 rounded-lg border-2 transition-all ${
                    !isJobsMode ? 'border-blue-500 bg-blue-950/30' : 'border-slate-600 bg-slate-800/50'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-slate-100">Current Design</p>
                      <p className="text-sm text-slate-400">Rich gradients & animations</p>
                    </div>
                ...
                <div 
                  className={`p-3 rounded-lg border-2 transition-all cursor-pointer ${
                    isJobsMode ? 'border-slate-400 bg-slate-800/50' : 'border-slate-600 hover:border-slate-500'
                  }`}
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-slate-400">Minimal, elegant, focused</p>
                    </div>
                    {isJobsMode && <div className="w-3 h-3 bg-slate-400 rounded-full" />}
                  </div>
                </div>
              </div>
