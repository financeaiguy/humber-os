    ...
    <div className="space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white mt-1">
                {onboardingQueue.filter(e => e.status === 'in_progress').length}
              </p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white mt-1">
                {onboardingQueue.filter(e => e.status === 'pending' || e.status === 'scheduled').length}
              </p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white mt-1">
                {Math.round(onboardingQueue.reduce((sum, e) => sum + (e.completedSteps / e.totalSteps * 100), 0) / onboardingQueue.length)}%
              </p>
            </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          {onboardingQueue.map((employee, index) => (
            <motion.div
              key={employee.id}
