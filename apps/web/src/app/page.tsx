...
export default function HomePage() {
  return (
    <div className="space-y-8">
      ...
      >
        {[
          { label: 'Log Time', href: '/time', icon: Clock, color: 'from-blue-500 to-cyan-500' },
          { label: 'New Project', href: '/projects/new', icon: Activity, color: 'from-purple-500 to-pink-500' },
          { label: 'Team Report', href: '/team', icon: Users, color: 'from-green-500 to-emerald-500' },
          { label: 'Analytics', href: '/analytics', icon: TrendingUp, color: 'from-orange-500 to-red-500' },
        ].map((action) => (
          <Link
            key={action.label}
            href={action.href}
