...
export class RecruitingDatabase {
  ...
  async createRecruit(
    ...
    try {
      ...
      console.error('Database error creating recruit:', error)
      throw new RecruitingError(
    ...
    try {
      ...
      for (const record of records) {
        try {
          ...
          console.error(`Failed to decrypt recruit ${record.id}:`, decryptionError)
      ...
      console.error('Database error getting recruits:', error)
      throw new RecruitingError(
  ...
  async moveRecruitToOnboarding(
    ...
    try {
      ...
      console.error('Database error moving recruit to onboarding:', error)
      throw new RecruitingError(
  ...
  async anonymizeRecruit(
    ...
    try {
      ...
      console.error('Database error anonymizing recruit:', error)
      throw new RecruitingError(
