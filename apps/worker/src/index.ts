...
// Apply JWT authentication to ALL routes except health endpoint
// Security-first approach: authenticate everything by default
...
app.use('/docs', authMiddleware); // Protect documentation
app.use('/metrics', authMiddleware); // Protect metrics
